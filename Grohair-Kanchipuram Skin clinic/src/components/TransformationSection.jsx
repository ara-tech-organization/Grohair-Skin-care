...
const reviews = [
  {
    ...
    avatar: 'SK',
    color: '#c0001a',
    text: "I'm really happy with the hair treatment I took here. Doctor Bharathi mam is friendly, knowledgeable, and takes time to understand your hair concerns. Totally worth it!",
  },
  {
    name: 'Sanjai Kumar',
    time: '3 months ago',
    avatar: 'SK',
    color: '#7c3aed',
    text: "I have lots of Dandruff and Hairfall..just 4 sessions I attended, now my problems are clear 80%. New Hair growth is visible & Doctors are friendly and supportive. Thanks for your support.",
  },
  {
    name: 'The one',
    time: '4 months ago',
    avatar: 'TO',
    color: '#0891b2',
    text: "Being a doctor in profession I strongly recommend Advanced hairgro clinic - KANCHIPURAM branch especially for their reception and hospitality towards their clients without showing any partial behaviour. Its been my 3rd session already, am totally satisfied with their works.",
  },
  {
    name: 'Tamil Elakya',
    time: '7 months ago',
    avatar: 'TE',
    color: '#d97706',
    text: "I had a wonderful experience here. The treatment was smooth from the beginning to end. The clinic maintains high standards of cleanliness and hygiene, and the overall environment is calm and welcoming.",
  },
  {
    name: 'Nathiya Ravi',
    time: '3 months ago',
    avatar: 'NR',
    color: '#16a34a',
    text: "Got skin treatment here seeing good results. Good and hygienic clinic. Doctor Dr. Bharathi mam gave proper consultation. Thanks adgro team.",
  },
]
