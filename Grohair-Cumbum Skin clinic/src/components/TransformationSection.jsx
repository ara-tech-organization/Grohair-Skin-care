...
const reviews = [
  {
    ...
    badge: 'Local Guide',
    color: '#7c3aed',
    text: "First of its kind clinic at Cumbum. World class aesthetic facility, completely equipped with well knowledgeable doctors. Step in for a new you.",
  },
  {
    name: 'thirumoorthy n',
    time: '8 months ago',
    ...
    badge: 'Local Guide',
    color: '#0891b2',
    text: "100 percentage result at this clinic. I done my hair transplant at Advanced Grohair clinic. The results are amazing — highly recommend for anyone considering hair restoration.",
  },
  {
    ...
    avatar: 'YK',
    color: '#d97706',
    text: "I had a really great experience at this hair clinic. The doctors and staff were very professional, friendly, and made me feel comfortable throughout the process. They explained every step clearly, gave me the right guidance for my hair concerns, and recommended treatments.",
  },
  {
    name: 'Sasi',
    time: '7 months ago',
    avatar: 'SA',
    color: '#c0001a',
    text: "I had a good experience at Advanced Gro Hair Hospital. The staff were professional, the treatment was well-explained. Definitely recommended for anyone considering hair treatment. Doctor Swathi and support staff were helpful and friendly. They made me feel comfortable during my session.",
  },
  {
    name: 'Amrith nsrith',
    time: '7 months ago',
    avatar: 'AN',
    color: '#16a34a',
    text: "Doctors are very good at explaining the hair growth treatment. I am very satisfied with the OLT treatment. The care and guidance provided throughout the process was excellent.",
  },
]
