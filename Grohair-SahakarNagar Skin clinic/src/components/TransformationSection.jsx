...
const reviews = [
  {
    ...
    color: '#7c3aed',
    badge: 'Local Guide',
    text: "I had come here for consultation for skin issues and the doctors suggested me a customised treatment tailored just for me. I'm extremely happy with the results and the staff is very good and approachable.",
  },
  {
    name: 'Chandrakanth',
    time: 'a day ago',
    avatar: 'CH',
    color: '#c0001a',
    text: "Recently I visited this clinic for hair treatment, I have taken their B7 PRP treatment, 3 sessions done, I can see good results in my hair fall, the whole staff and doctors are very kind.",
  },
  {
    name: 'Siji Antony',
    time: 'a day ago',
    avatar: 'SA',
    color: '#0891b2',
    text: "I visited this clinic for acne scar treatment. I can see visible results as the sessions progress. The doctors also suggested their exclusive range of products and I'm extremely happy with how they feel on my skin. Great experience at Adgrow!",
  },
  {
    name: 'Latha',
    time: 'a day ago',
    avatar: 'LA',
    color: '#d97706',
    text: "Excellent skin treatment at Advanced Gro Hair and Glo Skin Clinic. Professional doctors, great results, and very hygienic clinic. Totally worth it.",
  },
  {
    name: 'Ansal Antony',
    time: '4 days ago',
    avatar: 'AA',
    color: '#16a34a',
    text: "I had a wonderful experience at Adgrow, Sahakar Nagar. The doctors there are extremely professional and the staff is very helpful. I had a good experience there.",
  },
]
