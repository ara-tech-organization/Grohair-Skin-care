...
const reviews = [
  {
    ...
    avatar: 'MI',
    color: '#c0001a',
    text: "I had my hair transplant done at Advanced GroHair & GloSkin Clinic, Karaikudi, and I am very satisfied with the overall experience. From the first consultation, the doctors and staff explained the procedure clearly and patiently. The clinic is clean, professional, and truly focused on patient care.",
  },
  {
    name: 'karthik durai',
    time: '6 months ago',
    avatar: 'KD',
    color: '#7c3aed',
    text: "I had a really bad hair density. Personally recommend to everyone to visit at least once. I was having a lot of hair fall but now after treatment baby hairs are growing. I personally recommend to everyone to visit — the results are truly worth it.",
  },
  {
    name: 'Devi Priya',
    time: '6 months ago',
    avatar: 'DP',
    color: '#0891b2',
    text: "I was seeking skin treatment and found the right choice — Advanced Gro Hair & Glo Skin Clinic. It is the right choice for everyone looking for skin treatments. Nice consultation, nice gesture, nice ambiance. Overall a great experience to get rid of skin dullness.",
  },
  {
    name: 'ANBU',
    time: '8 months ago',
    avatar: 'AN',
    color: '#d97706',
    text: "The clinic is clean, modern and well maintained. Doctors are very knowledgeable and understanding — they explained the risk, benefits and aftercare in detail. Highly recommended for anyone considering hair or skin treatment.",
  },
  {
    name: 'Mani Mk',
    time: '7 months ago',
    avatar: 'MM',
    color: '#16a34a',
    text: "Enquired for hair fall issue and found this clinic. Wonderful explanation from Dr. Nanthini — she clearly explained all details about treatments. Blindly go for it. I personally recommend it to anyone searching for hair fall solutions.",
  },
]
