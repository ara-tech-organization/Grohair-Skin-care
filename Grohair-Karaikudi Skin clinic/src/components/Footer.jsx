...
const services = [
  { name: 'Laser Resurfacing', link: '#laser' },
  { name: 'Microneedling', link: '#micro' },
  { name: 'Chemical Peels', link: '#peels' },
  { name: 'Skin Rejuvenation', link: '#prp-skin' }
]
  ...
  return (
    <footer id="footer" className="bg-[#0f1117]">
      ...
      <div className="px-5 pt-7 pb-5 border-b border-white/10 flex items-center gap-6">
        <img src={logoImg} alt="Advanced GroSkin & GloSkin" className="h-12 w-auto object-contain" />
        <p className="text-[14px] text-white/35 leading-relaxed font-semibold">Advanced GroSkin &amp; GloSkin<br />Karaikudi</p>
      </div>
      ...
      <div className="flex px-5 py-6 border-b border-white/10 text-center">
        ...
        <div className="flex-1">
          <h4 className="text-[11px] font-extrabold text-white uppercase tracking-widest mb-4">Treatments</h4>
          <ul className="flex flex-col gap-3">
            {services.map((s) => (
      ...
      <div className="px-5 py-5 border-b border-white/10 flex flex-col gap-4">
        ...
        <a href="tel:+919575156789" className="flex items-center gap-3 group">
          ...
          <span className="text-[12px] text-white/45 hover:text-red-400 active:text-red-400 transition-colors">(+91) 95751 56789</span>
        </a>
      ...
      <div className="px-5 py-4 text-center">
        <p className="text-[11px] text-white/20">© 2026 GroSkin &amp; GloSkin. All rights reserved.</p>
      </div>
    </footer>
  )
}
