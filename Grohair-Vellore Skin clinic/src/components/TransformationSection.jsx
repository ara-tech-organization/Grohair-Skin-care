...
const reviews = [
  {
    ...
    avatar: 'RS',
    color: '#c0001a',
    text: "I recently completed my hair transplant at Advanced Grohair & Gloskin, Vellore, and I'm extremely satisfied with the results. The staff was professional, the procedure was smooth, and the care provided was excellent. My hair growth is natural and impressive. Highly recommended for anyone considering hair restoration treatment.",
  },
  {
    name: 'Madheswaran',
    time: '11 months ago',
    avatar: 'MD',
    color: '#7c3aed',
    text: "I came for dandruff treatment and PRP sessions for hair regrowth, and I'm really happy with the results. The doctor and nurse are kind-hearted, caring, and professional. They made me feel comfortable throughout the process. The clinic is clean and welcoming.",
  },
  {
    name: 'Amal Rickyson',
    time: '2 months ago',
    avatar: 'AR',
    color: '#0891b2',
    text: "Had my hair GFC treatment at Advanced Grohair recently. The doctor explained everything clearly and the staff was friendly, and the treatment went smoothly. After a few weeks, I've noticed reduced hair fall and healthier looking hair. I'm satisfied with the results and would definitely recommend Advanced GroHair.",
  },
  {
    name: 'PRAVEEN A S',
    time: 'a year ago',
    ...
    badge: 'Local Guide',
    color: '#d97706',
    text: "I recently had a fantastic experience at Adgro hair clinic Vellore. From the moment I walked in, I was greeted with warm hospitality and professionalism. The staff was incredibly responsive and attentive to all my questions and concerns. I look forward to continuing to support you in my hair journey!",
  },
  {
    name: 'Ramya devi',
    time: 'a year ago',
    avatar: 'RD',
    color: '#16a34a',
    text: "I visited Advanced Hairgro clinic Vellore branch for heavy dandruff and hair fall. They suggested me OLT and GFC treatment. The result is really amazing. My scalp is clean without dandruff and hair fall also controlled. Staff are friendly and service is good. Recommend for hair problems.",
  },
]
