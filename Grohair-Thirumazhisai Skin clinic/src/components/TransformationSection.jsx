...
const reviews = [
  {
    name: 'Krishnamoorthy M',
    time: 'a month ago',
    avatar: 'KM',
    color: '#c0001a',
    text: 'I visited the clinic for my hair fall issue. Dr. Karthika gave excellent consultation for my concern and suggested the Regen Pro 9 treatment for my hair condition. I also started my hair treatment at GroHair and GloSkin Thirumazhisai.',
  },
  {
    name: 'Stalin mani',
    time: '6 days ago',
    avatar: 'SM',
    color: '#7c3aed',
    text: 'I recently tried a cosmetic hair system and honestly, the transformation was amazing. Within a single session, I went from having visible hair loss to a full natural-looking hairstyle. The result boosted my confidence. If the hairline is done well, it is almost undetectable.',
  },
  {
    name: 'Sathish Sathish',
    time: 'a week ago',
    avatar: 'SS',
    color: '#0891b2',
    text: 'Completed 4 sessions of OLT treatment for dandruff. My dandruff is completely gone now. Really happy with the results. The products of this brand really work well, and staff nurse Narmadaa was very kind and polite throughout the procedures.',
  },
  {
    name: 'Yogeshwari G',
    time: 'a month ago',
    avatar: 'YG',
    color: '#d97706',
    text: 'I visited GroHair and GloSkin for my hair growth and dandruff condition. The doctor explained my condition very well and suggested the right treatment. I booked Regen Pro 6 sessions and I am expecting great results.',
  },
  {
    name: 'Budding Youtuber Crafts',
    time: 'a week ago',
    avatar: 'BY',
    color: '#16a34a',
    text: 'The session was smooth and almost painless. The staff were very professional and hygienic throughout the process. I could already notice reduced hair fall after a few sessions with Regen Pro GFC treatment. Highly recommend!',
  },
]
