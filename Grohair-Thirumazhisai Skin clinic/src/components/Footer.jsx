...
const quickLinks = [
  ...
  { name: 'Patients Say', link: '#reviews' }
]
const services = [
  { name: 'PRP Therapy', link: '#treatments' },
  { name: 'GFC Therapy', link: '#treatments' },
  { name: 'Scalp Care', link: '#treatments' },
  ...
  return (
    <footer id="footer" className="bg-[#0f1117]">
      ...
      <div className="px-5 pt-7 pb-5 border-b border-white/10 flex items-center gap-6">
        <img src={logoImg} alt="Grohair" className="h-20 w-auto object-contain" />
        <p className="text-[14px] text-white/35 leading-relaxed font-semibold">Advanced Grohair &amp; Gloskin<br />Thirumazhisai Poonamallee</p>
      </div>
      ...
      <div className="px-5 py-5 border-b border-white/10 flex flex-col gap-4">
        ...
        >
          ...
          <span className="text-[12px] text-white/45 leading-relaxed hover:text-red-400 active:text-red-400 transition-colors">
            1st floor, No. 40 trunk road, Poonamallee, Chennai - 600056, Landmark: Near GRT Jewellers Poonamallee
          </span>
        </a>

        {/* Phone → Dialer */}
        <a href="tel:+919047656789" className="flex items-center gap-3 group">
          ...
          <span className="text-[12px] text-white/45 hover:text-red-400 active:text-red-400 transition-colors">90476 56789</span>
        </a>

        {/* Email → Mail app */}
        <a href="mailto:thirumazhisai@adgrohair.com" className="flex items-center gap-3 group">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className="w-4 h-4 text-red-500 shrink-0">
