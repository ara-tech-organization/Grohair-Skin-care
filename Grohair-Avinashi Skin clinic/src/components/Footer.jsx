  ...
  return (
    <footer id="footer" className="bg-[#0f1117]">
      ...
      <div className="px-5 pt-7 pb-5 border-b border-white/10 flex items-center gap-6">
        <img src={logoImg} alt="Advanced GroSkin & GloSkin" className="h-20 w-auto object-contain" />
        <p className="text-[14px] text-white/35 leading-relaxed font-semibold">Advanced GroSkin &amp; GloSkin<br />Avinashi Road Coimbatore</p>
      </div>
