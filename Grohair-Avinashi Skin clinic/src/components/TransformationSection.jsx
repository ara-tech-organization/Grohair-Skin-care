...
const reviews = [
  {
    ...
    avatar: 'RS',
    color: '#c0001a',
    text: "I visited this clinic for skin consultation and I'm very happy with the service. The consultation was very thorough, and the doctor Elakiya patiently answered all my questions. They suggested a customized treatment plan. The staff is supportive and the follow-ups are well organized.",
  },
  {
    name: 'Inba Sekar',
    time: '2 weeks ago',
  ...
  },
  {
    ...
    avatar: 'JK',
    color: '#d97706',
    text: "I recently completed three skin rejuvenation sessions at Advanced GroSkin & GloSkin, and the overall experience has been highly satisfying. The clinic maintains excellent hygiene standards, and the staff is well-trained, courteous, and professional. Each session was conducted efficiently, with the medical team explaining the procedure clearly and ensuring comfort throughout. I'm excited to continue my sessions and see visible changes in my skin! ❤️👍",
  },
  {
    name: 'Raja D',
    time: '8 weeks ago',
    ...
    color: '#16a34a',
    badge: 'Local Guide',
    text: 'I recently completed CHS system at Advanced GroSkin & GloSkin, and the overall experience has been highly satisfying. The clinic maintains excellent hygiene standards, and the staff is well-trained, courteous, and professional. Specially skin expert Mansoor brother treating me well and doing great work ❤️',
  },
]
