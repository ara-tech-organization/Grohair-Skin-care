...
const reviews = [
  {
    ...
    avatar: 'SJ',
    color: '#c0001a',
    text: "I recently completed my treatment at this grohair clinic and I am extremely satisfied with my experience. From my first consultation, Dr. Farhana listened carefully to my concerns and gave me a clear treatment plan. She is knowledgeable and I'm very happy with the results.",
  },
  {
    name: 'Henna Thomas',
    time: '3 months ago',
    avatar: 'HT',
    color: '#7c3aed',
    text: "I am currently undergoing laser treatment at Advance GroHair and GloSkin Clinic, Thrissur and am very satisfied with the results. The treatment is reasonably priced, and the staffs are highly professional, responsive, and courteous.",
  },
  {
    name: 'Krishna Anandhan',
    time: '8 months ago',
    avatar: 'KA',
    color: '#0891b2',
    text: "My hair transplant done here... 💯% satisfied and very friendly atmosphere. Very premium service with affordable cost. The overall experience was wonderful — I will recommend this place to everyone.",
  },
  {
    ...
    avatar: 'MS',
    color: '#d97706',
    text: "I recently completed my Regen Pro 9 hair treatment, and I'm truly impressed with the results. The team was professional, knowledgeable, and made me feel comfortable throughout the process. After a few sessions, I've noticed significant improvement.",
  },
  {
    name: 'Sumitha Sukumaran',
    time: 'a year ago',
    avatar: 'SS',
    color: '#16a34a',
    badge: 'Local Guide',
    text: "I had the pleasure of undergoing Laser Hair Reduction treatments at GroHair & GloSkin in Thrissur with Dr. Gayathri. The experience was highly satisfactory and well worth the outlay. I would confidently rate my experience 5 out of 5.",
  },
]
