...
const reviews = [
  {
    name: 'Reginald Rooban P',
    time: '2 months ago',
    avatar: 'RR',
    color: '#c0001a',
    text: "I've done 3 sessions of OLT treatment at Advance Grow Hair. The staff are friendly and explain everything clearly. The treatment is comfortable, and I've already noticed less hair fall. It's not a quick fix, but I can see good improvement so far.",
  },
  {
    name: 'Nagamanikandan Tamilselvan',
    time: '6 months ago',
    avatar: 'NT',
    color: '#7c3aed',
    text: "I recently started my GFC hair growth treatment at Advanced Grohair & Gloskin, and I'm very happy with the results so far! Having completed 3 sessions, I'm already noticing significant improvements in my hair thickness. The staff are professional and the clinic is clean and welcoming.",
  },
  {
    name: 'Shameer A',
    time: '6 months ago',
    avatar: 'SA',
    color: '#0891b2',
    text: "Dr. is an excellent, patient-focused physician who takes the time to explain things clearly. I felt heard and understood, and the staff were friendly and efficient, making my visit a positive experience. The clinic atmosphere is neat, clean and well maintained.",
  },
  {
    name: 'Vasanth Kumar',
    time: '7 months ago',
    avatar: 'VK',
    color: '#d97706',
    text: "I visited Advanced GroHair & GloSkin Clinic for GFC (Growth Factor Concentrate) treatment. The staff were professional and explained the procedure clearly. The clinic was clean and comfortable with friendly service. Very happy with the overall experience.",
  },
  {
    name: 'Mahe G',
    time: '5 months ago',
    avatar: 'MG',
    color: '#16a34a',
    text: "Most trusted and definitely a life turning place for everyone. I heard reviews from others who took treatment in different clinics — no one gives a review like what I personally felt at Ad Gro Hair & Skin Clinic. The care and professionalism here is truly outstanding.",
  },
]
