...
const MAPS_URL = 'https://www.google.com/maps/search/?api=1&query=172%2F3%2C+Marudhachalapuram+Main+Rd%2C+Near+60+Feet+Rd%2C+Tiruppur%2C+Tamil+Nadu+641603'
  ...
  return (
    <footer id="footer" className="bg-[#0f1117]">
      ...
      <div className="px-5 pt-7 pb-5 border-b border-white/10 flex items-center gap-3 min-[375px]:gap-4 min-[425px]:gap-6">
        ...
        <p className="text-[13px] min-[375px]:text-[15px] min-[425px]:text-[14px] text-white/35 leading-relaxed font-semibold whitespace-nowrap">Advanced Grohair &amp; Gloskin<br />Tiruppur</p>
      </div>
      ...
      <div className="px-5 py-5 border-b border-white/10 flex flex-col gap-4">
        ...
        >
          ...
          <span className="text-[12px] text-white/45 leading-relaxed hover:text-red-400 active:text-red-400 transition-colors">
            172/3, Marudhachalapuram Main Rd, Near 60 Feet Rd, Tiruppur, Tamil Nadu 641603
          </span>
        </a>

        {/* Phone → Dialer */}
        <a href="tel:+919626056789" className="flex items-center gap-3 group">
          ...
          <span className="text-[12px] text-white/45 hover:text-red-400 active:text-red-400 transition-colors">96260 56789</span>
        </a>

        {/* Email → Mail app */}
        <a href="mailto:tiruppur@adgrohair.com" className="flex items-center gap-3 group">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className="w-4 h-4 text-red-500 shrink-0">
            <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/>
            <polyline points="22,6 12,13 2,6"/>
          </svg>
          <span className="text-[12px] text-white/45 hover:text-red-400 active:text-red-400 transition-colors">tiruppur@adgrohair.com</span>
        </a>
