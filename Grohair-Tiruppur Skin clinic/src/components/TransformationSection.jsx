...
const reviews = [
  {
    ...
    avatar: 'AB',
    color: '#c0001a',
    text: "GrowHair Clinic has delivered an excellent experience from start to finish. The consultation was transparent, with the doctor clearly explaining the procedure, expected results, and after-care requirements. The clinic maintains high hygiene standards and the staff are warm and professional. Highly recommended!",
  },
  {
    name: 'Naveen Kumar',
    time: '5 months ago',
    avatar: 'NK',
    color: '#7c3aed',
    text: "I recently got a hair treatment done here, and I'm absolutely impressed! My hair feels softer, smoother, and much healthier. The staff were professional, friendly, and explained each step clearly. The results exceeded my expectations — definitely worth it! Highly recommend this clinic for anyone looking for quality hair care.",
  },
  {
    name: 'Karthikeyan P',
    time: '3 months ago',
    avatar: 'KP',
    color: '#0891b2',
    text: "I had an outstanding experience with the team at Advance Hair Growth and Skin Care. The doctors and staff were incredibly supportive, and the level of care I received was truly impressive.",
  },
  {
    name: 'Vikram Cibi',
    time: '8 months ago',
    avatar: 'VC',
    color: '#d97706',
    text: "Their service and hospitality were absolutely top-notch! The staff was friendly, attentive, and made sure everything was perfect throughout. You can truly feel the care and effort they put into every detail. I highly recommend trying them out — you won't be disappointed. A must-visit for the best results!",
  },
  {
    name: 'King Dharun B',
    time: '4 months ago',
    avatar: 'KD',
    color: '#16a34a',
    text: "The place and ambience was very nice and satisfying. Thanks to Dr. Geetha Anjali and the entire Grow Hair Glow Skin team for the wonderful experience and excellent results.",
  },
]
