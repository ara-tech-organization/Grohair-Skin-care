...
const reviews = [
  {
    ...
    avatar: 'PT',
    color: '#7c3aed',
    text: "Visited Advanced GroHair and GloSkin clinic. Took consultation for hair problem, doc explained me everything regarding my issues. Staffs are very friendly and helpful. Aesthetic ambience — I would highly recommend this clinic for all skin and hair problems.",
  },
  {
    name: 'Saranya Gurusamy',
    time: '9 months ago',
    avatar: 'SG',
    color: '#16a34a',
    text: "Since 3 months of facing hair loss issue, came to visit the Dharmapuri clinic. Doctor recommended OLT for hair loss and GFC treatment for growth. Today is my 2nd GFC session — hair loss has reduced and I'm expecting my final outcome. Thanks to Dharmapuri AdGro Clinic!",
  },
  {
    name: 'ELAN',
    time: '9 months ago',
    avatar: 'EL',
    color: '#0891b2',
    text: "Very good ambience, staffs and in-house operation theatre. I was really impressed about the consultation and hospitality of the team. A complete and professional setup — highly recommended.",
  },
  {
    name: 'Vijaiyakanth Parthiban',
    time: '8 months ago',
    avatar: 'VP',
    color: '#c0001a',
    text: "I had a very good consultation — the doctor gave me the best explanation and treatment plan for my hair and skin problem. I took both skin and hair treatments here and got the best results. One of the best clinics in Dharmapuri.",
  },
  {
    ...
    color: '#d97706',
    badge: 'Local Guide',
    text: "Good experience — my concern was clearly explained and the cost is really reasonable. Fully satisfied with OLT. Great team and a clinic I'd happily recommend to anyone dealing with hair or skin issues.",
  },
]
