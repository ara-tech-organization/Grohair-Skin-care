...
const reviews = [
  {
    ...
    avatar: 'BR',
    color: '#c0001a',
    text: "I visited Advanced Grohair and Gloskin clinic to get my receding hairline corrected. I was clearly explained about my scalp health and was diagnosed with Androgenic alopecia grade 3, and was suggested to take Titanium FUE hair transplant. I am very happy with the results and the care I received.",
  },
  {
    name: 'Rama Krishnan',
    time: '5 months ago',
    avatar: 'RK',
    color: '#0891b2',
    text: "I visited Advanced GroHair & GloSkin clinic Cuddalore for my dandruff problem. Dr. Sruthi checked my scalp through a microscope and suggested oxygen laser therapy for 6 sessions — but in just 3 sessions it got reduced completely. Now I am so happy with the results!",
  },
  {
    name: 'Kutty Durga',
    time: '6 months ago',
    avatar: 'KD',
    color: '#7c3aed',
    text: "I had severe hair loss. Doctor suggested PRP treatment. Within 2 sessions my hair fall stopped completely! Highly recommend this clinic. Doctor is very friendly and also advised me on hair care routines. Thank you doctor!",
  },
  {
    name: 'Thiyagaraj Nagaraj',
    time: '3 months ago',
    avatar: 'TN',
    color: '#d97706',
    text: "I came here for dark and dull skin. Doctor Deepika suggested peel treatment. Within just 2 sessions I had visible results — my skin tone improved noticeably. Thanks to the doctor and the entire team at Advanced GroHair Cuddalore.",
  },
  {
    name: 'Kabi Vlogger',
    time: '2 months ago',
    avatar: 'KV',
    color: '#16a34a',
    text: "Visited Advanced GroHair GloSkin clinic for my skin and hair issues. Consulted Dr. Deepika, and undergoing treatment — I could see visible results in my very 1st session itself! Very satisfied. Staffs are very kind and professional.",
  },
]
