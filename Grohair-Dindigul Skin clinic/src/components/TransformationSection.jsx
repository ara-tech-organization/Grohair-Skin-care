...
const reviews = [
  {
    ...
    avatar: 'SV',
    color: '#c0001a',
    text: "I chose Advanced Grohair to treat my hair fall problem. I consulted Dr. Swathi mam — she clearly explained about my hair problems and suggested OLT and PRP treatment. I completed all my sessions and now I have got very very good results. Highly recommended!",
  },
  {
    name: 'nana 17',
    time: '4 months ago',
    avatar: 'NA',
    color: '#7c3aed',
    text: "I had done my hair transplant at Advanced Grohair & Gloskin clinic Dindigul and I'm really happy that I chose them. From the beginning, the doctor's consultation was excellent and the care from the nurses was wonderful. Truly a great experience.",
  },
  {
    name: 'Priyanka Manimuthu',
    time: '8 months ago',
    avatar: 'PM',
    color: '#0891b2',
    text: "I got my hair treatment here. Really satisfied with the results — my hairfall has drastically reduced and new hairs started growing. All staff are so friendly. My personal favourites are Dr. Swathi mam and nurse Geetha mam. They hear out all concerns patiently.",
  },
  {
    name: 'Safa Thabassum',
    time: '5 months ago',
    avatar: 'ST',
    color: '#d97706',
    text: "I had a wonderful experience at Advanced Grohair & Gloskin – DGL. The staff were super professional and friendly. I tried the Hydrafacial and Glutathione IV sessions — my skin feels clean, glowing, and refreshed. The clinic is very welcoming.",
  },
  {
    name: 'Vikas Gurusamy',
    time: '3 months ago',
    avatar: 'VG',
    color: '#16a34a',
    text: "I visited Adgro clinic in Dindigul, consulted by Dr. Krishnaveni. Her consultation was so calm and detailed — she explained everything clearly. After examining my scalp she suggested the best hair treatment. Very satisfied with her consultation. Thank you mam!",
  },
]
