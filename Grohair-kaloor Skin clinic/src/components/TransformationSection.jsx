...
const reviews = [
  {
    ...
    avatar: 'RC',
    color: '#c0001a',
    text: "My wife did her skin treatment at this clinic and had a great experience. Special thanks to Dr Teena for the excellent care and guidance. The staff were friendly with all technical support and guidance. The hospitality with high professionalism and hygiene was really amazing & appreciable. Highly recommended!",
  },
  {
    name: 'Nandagopal Thekkedath',
    time: '8 months ago',
    avatar: 'NT',
    color: '#7c3aed',
    text: "I had a wonderful experience with Dr. Aswin. From the initial consultation to the final results, everything was handled with professionalism and care. He took the time to understand my concerns, explained all available treatment options clearly. Highly satisfied with the outcome.",
  },
  {
    name: 'Athira S',
    time: '8 months ago',
    avatar: 'AS',
    color: '#0891b2',
    text: "I visited Advanced GroHair & GloSkin Clinic for my hair fall problem, and I'm really happy with the results. The doctor explained everything clearly, and the staff were friendly and professional. Within a few sessions, I saw a big reduction in hair fall and new growth starting. Highly recommend this clinic for anyone facing hair issues.",
  },
  {
    name: 'Anayat Ansari',
    time: '6 months ago',
    avatar: 'AA',
    color: '#d97706',
    text: "I have done my Hair Transplant from Advanced GroHair and GloSkin and I am really satisfied with the treatment! The results are visible and the team was professional throughout the entire process. Highly recommend.",
  },
  {
    name: 'Megha Biju',
    time: '3 months ago',
    avatar: 'MB',
    color: '#16a34a',
    text: "Completed my second session of Regen Pro GFC treatment for my hair. Baby hairs are growing and hairfall has reduced noticeably. Friendly staff and hospitality is overall good.",
  },
]
